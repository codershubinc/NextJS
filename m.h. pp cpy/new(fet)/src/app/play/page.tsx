...
function Page(playId: any) {
    ...
    // >=====> if user want to see all playlists
    const [displayAllPlayLists, setDisplayAllPlayLists] = useState(false);
    ...
    useEffect(() => {
        ...
        // }
        console.log('playId', playId?.playId);

        setPlayListId(playId?.playId);
    }, []);
        ...
        <PageUi className='h-full w-full '>
            ...
            {loading ? (
                ...
                <div className=' my-auto mt-3  h-[100%]  justify-around items-center '>
                    ...
                    >
                        <div
                        onClick={() => setDisplayAllPlayLists(true)}
                        >
                            back
                        </div>
